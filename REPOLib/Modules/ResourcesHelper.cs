...
public static class ResourcesHelper
{
    ...
    public static bool HasEnemyPrefab(EnemySetup enemySetup)
    {
        ...
        foreach (string? prefabPath in enemySetup.GetDistinctSpawnObjects().Select(GetEnemyPrefabPath))
    ...
    public static string GetValuablePrefabPath(GameObject prefab)
    {
        ...
        return prefab.TryGetComponent(out ValuableObject valuableObject)
            ? GetValuablePrefabPath(valuableObject)
            : string.Empty;
    }
